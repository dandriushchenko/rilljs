...
class TestDatum1 extends Datum<string, string> {
  ...
  get defn(): DatumDefinition {
    return TestDatum1.defn;
  }
  get ctor(): DatumConstructor<string> {
    return TestDatum1;
  }
  toJSON(): string {
    return this.value;
...
class TestDatum2 extends Datum<number, number> {
  ...
  get defn(): DatumDefinition {
    return TestDatum2.defn;
  }
  get ctor(): DatumConstructor<number> {
    return TestDatum2;
  }
  toJSON(): number {
    return this.value;
...
class TestDatumNoName extends Datum<number, number> {
  ...
  get defn(): DatumDefinition {
    return TestDatumNoName.defn;
  }
  get ctor(): DatumConstructor<number> {
    return TestDatumNoName;
  }
  toJSON(): number {
    return this.value;
  }
