...
export function Control(props: ControlProps) {
  ...
  return (
    <label className={classes} style={style}>
      <input type={type} checked={checked} defaultChecked={defaultChecked} onChange={onChange} disabled={disabled} />
      <span className={theme.controls.indicator}>{indicatorChildren}</span>
      {label}
    </label>
  );
}
